...
export function LevelAdjustment({
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-3">
      <h3 className="text-sm font-semibold mb-2">레벨별 조정</h3>
            ...
            {levels.map((level, index) => {
              ...
              return (
                <tr key={level} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                  <td className="py-1.5 px-2 text-xs font-medium text-gray-900">{level}</td>
                  <td className="py-1.5 px-2 text-xs text-center text-gray-600">
                  ...
                  <td className="py-1.5 px-2">
                    <input
                      ...
                      step="0.1"
                      className="w-16 px-1 py-0.5 text-xs text-center border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                    />
                  </td>
                  <td className="py-1.5 px-2">
                    <input
      ...
      <div className="mt-3 pt-2 border-t">
        <p className="text-xs font-medium text-gray-700 mb-2">일괄 조정</p>
        <div className="flex gap-2">
          ...
          <div className="flex items-center gap-1">
            <label className="text-xs text-gray-600">성과:</label>
            <input
              type="number"
              placeholder="일괄 적용"
              onChange={(e) => {
